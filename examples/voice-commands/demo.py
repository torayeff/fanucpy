...
class FanucVoiceCommand:
    ...
    def __init__(self, chunk=3024, frmat=pyaudio.paInt16, channels=1, rate=44100, py=pyaudio.PyAudio()):
        ...
        with open("initial-messages.json", 'r') as f:
        ...
        # Get the icons
        self.rec_icon = ImageTk.PhotoImage( Image.open("icons/rec.png").resize((300, 300)) )
        self.stop_icon = ImageTk.PhotoImage( Image.open("icons/stop.png").resize((300, 300)) )

        # Start and Stop buttons
        self.button = tkinter.Button(self.main, padx=10, pady=5,
                                     image=self.rec_icon, command=lambda: self.start_record())
        self.button.pack()
        tkinter.mainloop()
    ...
    def start_record(self):
        ...
        self.st = 1
        self.button.configure(command=lambda: self.stop(),
